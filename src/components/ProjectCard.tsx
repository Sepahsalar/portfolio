...
export function ProjectCard({ title, description, tech, demo, github }: Props) {
  return (
    <motion.div
      ...
      className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm
                 hover:shadow-md transition dark:border-slate-800 
                 dark:bg-slate-900/40 backdrop-blur-sm"
    >
